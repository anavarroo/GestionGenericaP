...
public class ResponseMetricsAspect {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ResponseMetricsAspect.class);

    @Around("execution(* org.springframework.cloud.gateway.handler.FilteringWebHandler.handle(..))")
    public Object measureResponseProcessingTime(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            logger.info("Response: {} {} [{}] - Duracion: {} ms - Estado: {} - Codigo de respuesta: {}", method, uri, contentType, duration, requestState, statusCode);
        }
